...
void ConvertToPostfix(char infix_exp[], char postfix_exp[])
{ 
	int i, j;
	char item;
	char x;
...
int main()
{
	...
	/* why we asked the user to enter infxi expression
	* in parentheses ( )
	* What changes are required in porgram to
	* get rid of this resrtiction since it is not
	* in algorithm
	* */
	...
	ConvertToPostfix(infix,postfix);                   /* call to convert */
